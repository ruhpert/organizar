...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Todo_Category'
        db.create_table(u'_todo_todo_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal(u'_todo', ['Todo_Category'])

        # Adding model 'Todo_Priority'
        db.create_table(u'_todo_todo_priority', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=2000)),
        ))
        db.send_create_signal(u'_todo', ['Todo_Priority'])

        # Adding model 'Todo'
        db.create_table(u'_todo_todo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('text', self.gf('django.db.models.fields.CharField')(max_length=2000)),
            ('event', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['_calendar.Event'], null=True, blank=True)),
            ('done', self.gf('django.db.models.fields.NullBooleanField')(null=True, blank=True)),
            ('category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['_todo.Todo_Category'])),
            ('priority', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['_todo.Todo_Priority'])),
        ))
        db.send_create_signal(u'_todo', ['Todo'])

        # Adding M2M table for field users on 'Todo'
        m2m_table_name = db.shorten_name(u'_todo_todo_users')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('todo', models.ForeignKey(orm[u'_todo.todo'], null=False)),
    ...
    def backwards(self, orm):
        # Deleting model 'Todo_Category'
        db.delete_table(u'_todo_todo_category')

        # Deleting model 'Todo_Priority'
        db.delete_table(u'_todo_todo_priority')

        # Deleting model 'Todo'
        db.delete_table(u'_todo_todo')

        # Removing M2M table for field users on 'Todo'
        db.delete_table(db.shorten_name(u'_todo_todo_users'))
    ...
    models = {
        ...
        u'_todo.todo': {
            ...
            'category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['_todo.Todo_Category']"}),
            'done': ('django.db.models.fields.NullBooleanField', [], {'null': 'True', 'blank': 'True'}),
            'event': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['_calendar.Event']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'priority': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['_todo.Todo_Priority']"}),
            'text': ('django.db.models.fields.CharField', [], {'max_length': '2000'}),
            'users': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'users_of_todo'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['auth.User']"})
        },
        u'_todo.todo_category': {
            'Meta': {'object_name': 'Todo_Category'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '2000'})
        },
        u'_todo.todo_priority': {
            'Meta': {'object_name': 'Todo_Priority'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '2000'})
        },
        u'auth.group': {
